...
public class SettingsMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Get screen resolutions available
        ...
        //Add the resolution options and load previous saved default options
    ...
    public void SaveSettings() // Player Preferences saving, call when leaving settings menu
    {
